...
@section('title', 'Proposal Lanjut')
@section('content')

@if ($mhs[0]->progress < 2)
    <h6>Anda belum menyelesaikan kolokium awal!</h6>
@else



@if ($cond === 1)
    <h6>Silahkan mengupload proposal lanjut anda. Format file : .docx. Maksimum size: 10MB</h6>
    <form action="{{ route('kolokium_lanjut_proposal_upload') }}" method="POST" enctype="multipart/form-data">
        @csrf
            ...
            <div class="content">
                <div class="row">
                    <div class="col-sm-6">
                        ...
                        <label class="mt-1" for='file_proposal'>Upload Proposal Lanjut</label>
                        ...
                        <div class="modal fade" id="modal_simpan">
                            ...
                            <div class="modal-content bg-white">
                                ...
                                Apakah anda yakin ingin mengupload proposal lanjut? 
                                <br>
...
@elseif ($cond === 2)
    <p>Anda sudah mengupload proposal lanjut, silahkan menunggu dosen pembimbing memverifikasi dan mengecek proposal lanjut anda!</p>
    <p>Status : </p>
    <p>Dosen 1 : 
...
@elseif ($cond === 3)
    <p>Anda sudah mengupload revisi proposal lanjut, silahkan menunggu dosen pembimbing memverifikasi dan mengecek revisi anda!</p>
    <p>Status : </p>
    <p>Dosen 1 : 
        @if ($data_proposal_seen_last->check1 === 0)
            Belum mengecek  
...
@elseif ($cond === 4)
    <h6>Silahkan mengupload revisi proposal lanjut anda. Format file : .docx. Maksimum size: 10MB</h6>
    <form action="{{ route('kolokium_lanjut_proposal_upload') }}" method="POST" enctype="multipart/form-data">
        @csrf
        <input type="hidden" class="form-control" name="name_mhs" value={{ $mhs[0]->name }}>
            ...
            <div class="content">
                <div class="row">
                    <div class="col-sm-6">
                        ...
                        <label class="mt-1" for='file_proposal'>Upload Revisi Proposal Lanjut</label>
                        <div class="custom-file">
                            <input type="file" class="custom-file-input col-sm-6 @error('file_proposal') is-invalid @enderror" id="file_proposal" name="file_proposal">
                            <label class="custom-file-label" for="file_proposal">Pilih File</label>
                            @error('file_proposal')
...
@elseif ($cond === 5)
    <p>Proposal anda sudah di setujui oleh dosen 1 dan dosen 2. Silahkan lanjut dengan mengupload berkas kolokium lanjut anda menu upload berkas kolokium lanjut.</p>
    ...
    <form action="{{ route('kolokium_lanjut_proposal_download') }}" method="POST" enctype="multipart/form-data">
        @csrf
        <input type="hidden" class="form-control" name="name_mhs" value={{ $mhs[0]->name }}>
...
@elseif ($cond === 6)
    ...
    @elseif ($cond === 9)
        ...
        {{-- <p>Revisi review proposal anda sudah di setujui oleh dosen 1 dan dosen 2. Silahkan lanjut dengan mengupload revisi tersebut di halaman upload berkas kolokium.</p> --}}
...
@if ($cond!== 1)
    <label for="tabel_proposal" class="mt-5">Tabel History Proposal Lanjut</label>
