...
@section('title', 'Pengajuan Nilai Publikasi')
@section('content')
...
<h6>Tiap file, Max: 10MB; Bertipe .jpg, .png, .pdf</h6>

<form action="{{ route('pengajuan_publikasi_upload') }}" method="POST" enctype="multipart/form-data">
    @csrf
    ...
    <div class="content">
        <div class="row">
            ...
            <div class="col-sm-6">
                ...
                <label class="mt-3" for='makalah'>1. Makalah yang dilampiri persetujuan pembimbing</label>
