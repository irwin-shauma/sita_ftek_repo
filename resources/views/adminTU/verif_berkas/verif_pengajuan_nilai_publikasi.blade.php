...
@section('title', 'Verifikasi Pengajuan Nilai Publikasi')
@section('content')
<table class='table table-bordered table-striped' id='example1'>
    ...
    <tr>
        ...
        <td>
            <a href="{{ route('download_berkas_nilai_publikasi', ['user' => $data->nim]) }}" class="btn btn-sm btn-warning">Download</a>  
                ...
                <div class="modal-dialog">
                    <div class="modal-content bg-white">
                        ...
                        <div class="modal-header">
                            <h4 class="modal-title">Verifikasi Pengajuan Nilai Publikasi</h4>
                        ...
                        <div class="modal-body">
                            <form action="{{ route('verif_pengajuan_nilai_publikasi_verified', ['user' => $data->nim]) }}" method="POST">
                            @csrf
                            <div class="row">
