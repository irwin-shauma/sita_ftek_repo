        ...
        <td>
            ...
            <div class="modal fade" id="modal_validasi-{{ $data->nim }}">
                <div class="modal-dialog modal-lg">
                    ...
                    <form action="{{ route('korkon_elektro_validasi_revisi_lanjut_download') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    ...
                    <div class="modal-footer justify-content-between">
                        ...
                        <button type="submit" class="btn btn-primary" formaction="{{ route('korkon_elektro_validasi_revisi_lanjut_validated') }}">Validasi</button>
                    </div>
