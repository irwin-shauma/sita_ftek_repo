        ...
        <td>
            ...
            <div class="modal fade" id="modal_validasi-{{ $data->nim }}">
                <div class="modal-dialog modal-lg">
                    ...
                    {{-- <form action="{{ route('korkon_elektro_validasi_revisi_awal_validated')}}" method="POST"> --}}
                    <form action="{{ route('korkon_elektro_validasi_revisi_awal_download') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td>
                                    ...
                                    {{-- <a href="{{ route('korkon_elektro_download_berkas_awal', ['user' => $data->nim]) }}" class="btn btn-sm btn-warning">Download</a> --}}
                                </td>
                            </tr>
                            <tr>
                                <td>Reviewer 1</td>
                    ...
                    <div class="modal-footer justify-content-between">
                        ...
                        <button type="submit" class="btn btn-primary" formaction="{{ route('korkon_elektro_validasi_revisi_awal_validated') }}">Validasi</button>
                    </div>
