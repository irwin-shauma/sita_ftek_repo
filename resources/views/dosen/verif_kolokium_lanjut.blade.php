...
<table class='table table-bordered table-striped' id="example1">
      ...
      <tbody>
        ...
        <tr>
            ...
            <td>
              <a href="{{ route('download_berkas_lanjut', ['user' => $data->nim]) }}" class="btn btn-sm btn-warning">Download</a>  
                ...
                <div class="modal-dialog">
                  <div class="modal-content bg-white">
                    ...
                    <div class="modal-body">
                      <form action="{{ route('verif_kolokium_lanjut_verified', ['user' => $data->nim]) }}" method="POST">
                      @csrf
                      <div class="row">
                        <div class="col-md-6">
                          <h5>NIM : {{ $data->nim }}</h5>
