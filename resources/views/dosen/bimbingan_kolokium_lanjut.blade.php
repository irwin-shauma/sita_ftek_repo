...
@section('title', 'Bimbingan Kolokium Lanjut')
@section('content')
    <label for="tabel_proposal">Tabel Proposal Lanjut Pembimbing 1</label>
            ...
            <tbody>
                ...
                @if ($mhs_dosen1 !== 'empty' && $data_proposal_dosen1 !== 'empty')
                    ...
                    <tr>
                        ...
                        <td>
                            <form action="{{ route('bimbingan_kolokium_lanjut_action') }}" method="POST" enctype="multipart/form-data">
                            @csrf
                            ...
                            <button type="submit" class="btn btn-sm btn-info" formaction="{{ route('bimbingan_kolokium_lanjut_download') }}">Download</button>
    ...
    <label for="tabel_proposal" class="mt-5">Tabel Proposal Lanjut Pembimbing 2</label>
