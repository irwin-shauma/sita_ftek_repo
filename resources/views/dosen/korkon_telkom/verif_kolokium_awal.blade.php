...
<table class='table table-bordered table-striped' id='example1'>
      ...
      <tbody>
        ...
        <tr>
            ...
            <td>
              <a href="{{ route('korkon_telkom_verif_kolokium_awal_download', ['user' => $data->nim]) }}" class="btn btn-sm btn-warning">Download</a>
                ...
                <div class="modal-dialog">
                  <div class="modal-content bg-white">
                    ...
                    <div class="modal-body">
                      <form action="{{ route('korkon_telkom_verif_kolokium_awal_verified', ['user' => $data->nim]) }}" method="POST">
                        @csrf
                        <div class="row">
                          <div class="col-md-6"> 
                            <h5>NIM : {{ $data->nim }}</h5> 
