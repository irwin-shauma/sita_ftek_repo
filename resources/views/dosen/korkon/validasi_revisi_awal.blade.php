        ...
        <td>
            ...
            <div class="modal fade" id="modal_validasi-{{ $data->nim }}">
                <div class="modal-dialog modal-lg">
                    ...
                    {{-- <form action="{{ route('validasi_revisi_awal_validated')}}" method="POST"> --}}
                    <form action="{{ route('validasi_revisi_awal_download') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    ...
                    <div class="modal-footer justify-content-between">
                        ...
                        <button type="submit" class="btn btn-primary" formaction="{{ route('validasi_revisi_awal_validated') }}">Validasi</button>
                    </div>
