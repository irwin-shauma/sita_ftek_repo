...
class KorkonTek_KomController extends Controller
{
    //----------------------------------------------------------------------
    // Fungsi untuk permission Korkon Tekkom
    //----------------------------------------------------------------------
    public function korkon_tek_kom_verif_kolokium_awal()
    {
        $lists_id = Kolokium_awal::whereColumn('check_korkon', '<', 'check_mhs_send')
            ->where('tipe_korkon', 'korkon_tek_kom')
            ->pluck('id');
        if ($lists_id->count() != 0) {
            $lists_array = $lists_id->toArray();
            $lists = Mahasiswa::whereIN('id', $lists_array)->get();
        } else {
            return view('dosen.korkon_tek_kom.verif_kolokium_awal', compact(
                'lists',
    ...
    public function korkon_tek_kom_verif_kolokium_awal_download($id)
    {
    ...
    public function korkon_tek_kom_verif_kolokium_awal_verified(VerifKolokiumAwalRequest $request)
    {
    ...
    public function korkon_tek_kom_validasi_revisi_awal()
    {
        //Untuk mengecek apakah ada proposal yang sudah direview reviewer.
        // Ini nanti tulis di notepad ya caranya!

        $mahasiswa_sesuai_korkon = Kolokium_awal::where('tipe_korkon', 'korkon_tek_kom')
        ...
        return view('dosen.korkon_tek_kom.validasi_revisi_awal', compact('data_mhs', 'data_proposal_seen', 'data_review1', 'data_review2'));
    }

    public function korkon_tek_kom_validasi_revisi_awal_download(Request $request)
    {
    ...
    public function korkon_tek_kom_validasi_revisi_awal_validated(Request $request)
    {
        $data_all = $request->all();
        ...
        $buatnomor = NomorSurat::create([
            ...
            // 'tanggal_kop' => $current_time->isoFormat('LL'),
    ...
    //------------------------------------------------------------------------------------------
    public function korkon_tek_kom_verif_kolokium_lanjut()
    {
        ...
        if ($lists_id->count() != 0) {
            ...
            return view('dosen.korkon_tek_kom.verif_kolokium_lanjut', compact(
                'lists',
    ...
    public function korkon_tek_kom_verif_kolokium_lanjut_download($id)
    {
    ...
    public function korkon_tek_kom_verif_kolokium_lanjut_verified(VerifKolokiumLanjutRequest $request)
    {
        //$id berisi nim mhs.
        $validated = $request->validated();
        if ($validated['check_korkon'] < 1 || $validated['check_korkon'] == null) {
    ...
    public function korkon_tek_kom_validasi_revisi_lanjut()
    {
        $mahasiswa_sesuai_korkon = Kolokium_lanjut::where('tipe_korkon', 'korkon_tek_kom')
            ->where('check_korkon', 2)
            ->pluck('mhs_id');
        if ($mahasiswa_sesuai_korkon->count() != 0) {
            $mahasiswa_sesuai_korkon_array = $mahasiswa_sesuai_korkon->toArray();
        ...
        return view('dosen.korkon_tek_kom.validasi_revisi_lanjut', compact('data_mhs', 'data_proposal_seen', 'data_review1', 'data_review2'));
    }

    public function korkon_tek_kom_validasi_revisi_lanjut_download(Request $request)
    {
        $data_all = $request->all();
        $id = $data_all['nim'];
        if ($data_all['action'] == 'mahasiswa') {
    ...
    public function korkon_tek_kom_validasi_revisi_lanjut_validated(Request $request)
    {
        $data_all = $request->all();
    ...
    //-------------------------------------------------------------------------------------------------------------
    public function korkon_tek_kom_penjadwalan_awal()
    {
        $current = Carbon::now();
        $dosen = Dosen::all();
        ...
        return view('dosen.korkon_tek_kom.penjadwalan_awal', compact('lists', 'nama', 'mhs', 'dosen', 'current', 'lists_dosen'));
    }

    public function korkon_tek_kom_penjadwalan_awal_data(PenjadwalanAwalRequest $request)
    {
        $current = Carbon::now();
        $validated = $request->validated();
    ...
    //-------------------------------------------------------------------------------------------------------------
    public function korkon_tek_kom_penjadwalan_lanjut()
    {
        ...
        // } else {
        //     return view('dosen.korkon_tek_kom.penjadwalan_lanjut', compact('lists', 'nama', 'mhs', 'dosen', 'current'));
        // }
        ...
        return view('dosen.korkon_tek_kom.penjadwalan_lanjut', compact('lists', 'nama', 'mhs', 'dosen', 'current', 'reviewer1', 'reviewer2'));
    }

    public function korkon_tek_kom_penjadwalan_lanjut_data(PenjadwalanLanjutRequest $request)
    {
        $current = Carbon::now();
        $validated = $request->validated();
        $mhs = Mahasiswa::where('id', $validated['id_mhs'])->get();
